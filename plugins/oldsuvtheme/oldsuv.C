...
OLDSUVMain::OLDSUVMain(PluginServer *server)
 : PluginTClient(server)
{
}

OLDSUVMain::~OLDSUVMain()
{
}

char* OLDSUVMain::plugin_title()
{
	return "OLD-S.U.V.";
}

Theme* OLDSUVMain::new_theme()
{
	theme = new OLDSUV;
	extern unsigned char _binary_oldsuv_data_start[];
	theme->set_data(_binary_oldsuv_data_start);
	return theme;
}
...
void OLDSUV::get_mwindow_sizes(MWindowGUI *gui, int w, int h)
{
	mbuttons_x = 0;
...
void OLDSUV::get_cwindow_sizes(CWindowGUI *gui, int cwindow_controls)
{
	if(cwindow_controls)
	{
SET_TRACE
...
void OLDSUV::get_recordgui_sizes(RecordGUI *gui, int w, int h)
{
	
}

void OLDSUV::get_rmonitor_sizes(int do_audio, 
	int do_video,
	int do_channel,
	int do_interlace,
	int do_avc,
...
void OLDSUV::get_vwindow_sizes(VWindowGUI *gui)
{
	vmeter_y = 5;
...
void OLDSUV::draw_rwindow_bg(RecordGUI *gui)
{
// 	int y;
// 	int margin = 50;
// 	int margin2 = 80;
...
void OLDSUV::draw_rmonitor_bg(RecordMonitorGUI *gui)
{
// 	int margin = 45;
// 	int panel_w = 300;
...
void OLDSUV::draw_mwindow_bg(MWindowGUI *gui)
{
// Button bar
...
void OLDSUV::draw_cwindow_bg(CWindowGUI *gui)
{
...
void OLDSUV::draw_vwindow_bg(VWindowGUI *gui)
{
...
void OLDSUV::get_preferences_sizes()
{
}


void OLDSUV::draw_preferences_bg(PreferencesWindow *gui)
{
	gui->draw_vframe(get_image("preferences_bg"), 0, 0);
}

void OLDSUV::get_new_sizes(NewWindow *gui)
{
}

void OLDSUV::draw_new_bg(NewWindow *gui)
{
	gui->draw_vframe(get_image("new_bg"), 0, 0);
}

void OLDSUV::draw_setformat_bg(SetFormatWindow *gui)
{
	gui->draw_vframe(get_image("setformat_bg"), 0, 0);
}


void OLDSUV::get_plugindialog_sizes()
{
	int x = 10, y = 30;
